    ...
    <header className="relative h-[870px] w-full flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
        <div className="max-w-2xl">
          <span className="text-primary-fixed-dim uppercase tracking-[0.3em] font-bold text-sm mb-4 block">
            Arquitectura del Descanso
          </span>
          <h1 className="text-white text-6xl md:text-8xl font-bold leading-[1.1] mb-8 tracking-tighter">
            Eleva tu
            <br />
            Bienestar.
          </h1>
          <p className="text-gray-200 text-xl mb-10 max-w-lg font-light leading-relaxed">
